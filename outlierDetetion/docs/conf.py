...
version_path = os.path.join(pyod_dir, 'odtoolkit', 'version.py')
...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', 'odtoolkit.test.rst']
...
latex_documents = [
    (master_doc, 'odtoolkit.tex', 'odtoolkit Documentation',
     'Yue Zhao', 'manual'),
]
...
man_pages = [
    (master_doc, 'odtoolkit', 'odtoolkit Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'odtoolkit', 'odtoolkit Documentation',
     author, 'odtoolkit', 'One line description of project.',
     'Miscellaneous'),
]
